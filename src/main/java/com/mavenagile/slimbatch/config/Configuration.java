...
public class Configuration
{
	...
	public Object getBean(String varBeanID, CProperties varCustomProperties) throws ConfigurationException
	{
		...
		if (aBean != null)
		{
			...
			{
				throw new ConfigurationException("Can not instantiate Bean with id[" + varBeanID + "] : " + e.getMessage() + "\n	bean has been defined as : " + aBean.toXML());
			}
		}
		return (null);
	}
	...
	public DataSource getDataSource(String varBeanID) throws ConfigurationException
	{
		...
		if (aBean != null)
		{
			...
			{
				throw new ConfigurationException("Can not instantiate DataSource with id[" + varBeanID + "] + has been defined as : " + aBean.toXML());
			}
		}
		return (null);
	}
	...
	{
		StringBuffer aBuffer = new StringBuffer(2048);
