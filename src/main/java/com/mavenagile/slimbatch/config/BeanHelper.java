...
public class BeanHelper
{
	...
	public static Method getMethod(Class<?> varTheClass, String varMethodName, Class<?> varArgumentTypes[]) throws Exception
	{
		...
		if (varTheClass != null)
		{
			...
			throw new Exception(varTheClass.getSimpleName() + " ::getMethod: no such Method [" + varMethodName + "]  in class  " + varTheClass.getName() + " or its super class");
		}
		else
		{
			LOGGER.error("Configuration error : " + varTheClass + "is null no Method [" + varMethodName + "]  in class  null or its super class");
			throw new Exception("Configuration error : varTheClass is null no Method [" + varMethodName + "]  in class  null or its super class");
		}
	}
	...
	public static boolean applySetMethod(Object varObject, String varMethodName, Object varValue) throws Exception
	{
		...
		try
		{
			boolean isValueString = varValue instanceof java.lang.String;
